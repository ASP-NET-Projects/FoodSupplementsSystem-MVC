...
namespace FoodSupplementsSystem.Tests.FoodSupplementsSystem.Controllers.SupplementsControllerTests
{
    ...
    public class SupplementViewModels_Destroy_Should
    {
        ...
        public void ReturnJsonResult_WhenGetToSupplementViewModels_Destroy()
        {
            ...
            //Act & Assert
            controller.WithCallTo(c => c.SupplementViewModels_Destroy(kendoDataRequest, supplementViewModel)).ShouldReturnJson();
        }

        [Test]
        public void ReturnJsonResultWithCorrectModelInstance_WhenGetToSupplementViewModels_Destroy()
        {
            //Arrange
            var supplementsService = new Mock<ISupplementsService>();
            var dropDownListPopulator = new Mock<IDropDownListPopulator>();
            ...
            //Act
            var controllerResult = controller.SupplementViewModels_Destroy(kendoDataRequest, supplementViewModel);
        ...
        [Test]
        public void ReturnJsonResultWithCorrectModel_WhenGetToSupplementViewModels_Destroy()
        {
            //Arrange
            var supplementsService = new Mock<ISupplementsService>();
            var dropDownListPopulator = new Mock<IDropDownListPopulator>();
